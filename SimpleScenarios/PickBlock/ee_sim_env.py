...
from utils import sample_box_pose, sample_cabinet_pose, SampleRightBoxCenterPosition, SampleLeftBoxCenterPosition
...
class TransferTask(BimanualViperXEETask):
    ...
    def initialize_episode(self, physics):
        ...
        LeftBoxCenterPosition = SampleLeftBoxCenterPosition()
        ...
        AllBoxPose = np.concatenate((RightRedBox, RightYellowBox, RightBlueBox, RightGreenBox, LeftRedBox, LeftYellowBox, LeftBlueBox, LeftGreenBox))
