...
def main(args):
    ...
    if task_name == "sim_open_cabinet_top_drawer":
        dataset_dir = 'data/OpenTopDrawer/'
    if task_name == "sim_open_cabinet_middle_drawer":
        dataset_dir = 'data/OpenMiddleDrawer/'
    if task_name == "sim_open_cabinet_bottom_drawer":
        dataset_dir = 'data/OpenBottomDrawer/'
