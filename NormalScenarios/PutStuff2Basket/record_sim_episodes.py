...
def main(args):
    ...
    if task_name == "sim_put_hammer_to_basket":
        dataset_dir = 'data/PutHammerToBasket/'
    elif task_name == "sim_put_camera_to_basket":
        dataset_dir = 'data/PutCameraToBasket/'
    elif task_name == "sim_put_green_stapler_to_basket":
        dataset_dir = 'data/PutGreenStaplerToBasket/'
    elif task_name == "sim_put_black_stapler_to_basket":
        dataset_dir = 'data/PutBlackStaplerToBasket/'
