...
def main(args):
    ...
    if task_name == "sim_put_duck_to_pan":
        dataset_dir = 'data/PutDuckToPan/'
    elif task_name == "sim_put_apple_to_pan":
        dataset_dir = 'data/PutAppleToPan/'
    elif task_name == "sim_put_pig_to_pan":
        dataset_dir = 'data/PutPigToPan/'
    elif task_name == "sim_put_teapot_to_pan":
        dataset_dir = 'data/PutTeapotToPan/'
    else:
        NotImplementedError
